...
filename_without_ext = 'C4_Cubic_R3_202511180801'  # 由实验脚本直接赋值
# 获取当前文件所在的目录
...
USE_PPO_LAGRANGIAN = True   # 是否启用PPO-Lagrangian策略
...
ENABLE_ACTION_MASK = True           # 是否启用动作掩码
MASK_RULE_TYPE = 'enhanced'            # 掩码规则类型：'basic'（基础规则）或 'enhanced'（增强规则含三峡规程）
ENABLE_NONLINEAR_MAPPING = True    # 是否启用非线性映射
NONLINEAR_MAPPING_TYPE = 'cubic'   # 非线性映射函数类型：'linear'/'square'/'sqrt'/'cubic'/'exp'/'log'
